...
#ifndef ROS_BABEL_FISH_METHOD_INVOKE_HELPERS_HPP
#define ROS_BABEL_FISH_METHOD_INVOKE_HELPERS_HPP
...
#define RBF2_INVOKE_FN ::ros_babel_fish::impl::invoke

#endif

/*!
 * @brief Invokes the given functor with the given message casted to the actual type of the given message and the
 *   optionally passed additional arguments.
 * For array messages the method is invoked with the given message casted to ArrayMessageBase.
 * This can be used with invoke_for_array_message to call for the concrete array message type.
...
/*!
 * @brief Invokes the given functor with the given value message casted to the actual type of the given message and the
 *   optionally passed additional arguments.
 *
 * @return The return value of the invoked method.
...
/*!
 * @brief Invokes the given functor with the given message casted to the actual type of the given array message and the
 *   optionally passed additional arguments.
 *
 * @return The return value of the invoked method.
 */
...
auto invoke_for_message( Message &msg, Callable &&f, Args &&...args )
{
  ...
  using ::ros_babel_fish::ValueMessage;
  switch ( msg.type())
  {
...
auto invoke_for_value_message( Message &msg, Callable &&f, Args &&...args )
{
  ...
  switch ( msg.type())
  {
    ...
    case MessageTypes::Compound:
    case MessageTypes::Array:
      throw BabelFishException( "invoke_for_value_message called with message that is not a ValueMessage!" );
    case MessageTypes::None:
    default:
  ...
  switch ( msg.elementType())
  {
    case MessageTypes::Float:
      return RBF2_INVOKE_FN( f,
                             msg.as<ArrayMessage_<value_type<MessageTypes::Float>::value, BOUNDED, FIXED_LENGTH >>(),
                             std::forward<Args>( args )... );
    case MessageTypes::Double:
      return RBF2_INVOKE_FN( f,
                             msg.as<ArrayMessage_<value_type<MessageTypes::Double>::value, BOUNDED, FIXED_LENGTH>>(),
                             std::forward<Args>( args )... );
    case MessageTypes::LongDouble:
      return RBF2_INVOKE_FN( f,
    ...
    case MessageTypes::Char:
      return RBF2_INVOKE_FN( f,
                             msg.as<ArrayMessage_<value_type<MessageTypes::Char>::value, BOUNDED, FIXED_LENGTH>>(),
                             std::forward<Args>( args )... );
    case MessageTypes::WChar:
      return RBF2_INVOKE_FN( f,
                             msg.as<ArrayMessage_<value_type<MessageTypes::WChar>::value, BOUNDED, FIXED_LENGTH>>(),
                             std::forward<Args>( args )... );
    case MessageTypes::Bool:
      return RBF2_INVOKE_FN( f,
                             msg.as<ArrayMessage_<value_type<MessageTypes::Bool>::value, BOUNDED, FIXED_LENGTH>>(),
                             std::forward<Args>( args )... );
    case MessageTypes::Octet:
      return RBF2_INVOKE_FN( f,
                             msg.as<ArrayMessage_<value_type<MessageTypes::Octet>::value, BOUNDED, FIXED_LENGTH>>(),
                             std::forward<Args>( args )... );
    case MessageTypes::UInt8:
      return RBF2_INVOKE_FN( f,
                             msg.as<ArrayMessage_<value_type<MessageTypes::UInt8>::value, BOUNDED, FIXED_LENGTH>>(),
                             std::forward<Args>( args )... );
    case MessageTypes::Int8:
      return RBF2_INVOKE_FN( f,
                             msg.as<ArrayMessage_<value_type<MessageTypes::Int8>::value, BOUNDED, FIXED_LENGTH>>(),
                             std::forward<Args>( args )... );
    case MessageTypes::UInt16:
      return RBF2_INVOKE_FN( f,
                             msg.as<ArrayMessage_<value_type<MessageTypes::UInt16>::value, BOUNDED, FIXED_LENGTH>>(),
                             std::forward<Args>( args )... );
    case MessageTypes::Int16:
      return RBF2_INVOKE_FN( f,
                             msg.as<ArrayMessage_<value_type<MessageTypes::Int16>::value, BOUNDED, FIXED_LENGTH>>(),
                             std::forward<Args>( args )... );
    case MessageTypes::UInt32:
      return RBF2_INVOKE_FN( f,
                             msg.as<ArrayMessage_<value_type<MessageTypes::UInt32>::value, BOUNDED, FIXED_LENGTH>>(),
                             std::forward<Args>( args )... );
    case MessageTypes::Int32:
      return RBF2_INVOKE_FN( f,
                             msg.as<ArrayMessage_<value_type<MessageTypes::Int32>::value, BOUNDED, FIXED_LENGTH>>(),
                             std::forward<Args>( args )... );
    case MessageTypes::UInt64:
      return RBF2_INVOKE_FN( f,
                             msg.as<ArrayMessage_<value_type<MessageTypes::UInt64>::value, BOUNDED, FIXED_LENGTH>>(),
                             std::forward<Args>( args )... );
    case MessageTypes::Int64:
      return RBF2_INVOKE_FN( f,
                             msg.as<ArrayMessage_<value_type<MessageTypes::Int64>::value, BOUNDED, FIXED_LENGTH>>(),
                             std::forward<Args>( args )... );
    case MessageTypes::String:
      return RBF2_INVOKE_FN( f,
                             msg.as<ArrayMessage_<value_type<MessageTypes::String>::value, BOUNDED, FIXED_LENGTH>>(),
                             std::forward<Args>( args )... );
    case MessageTypes::WString:
      return RBF2_INVOKE_FN( f,
                             msg.as<ArrayMessage_<value_type<MessageTypes::WString>::value, BOUNDED, FIXED_LENGTH>>(),
                             std::forward<Args>( args )... );
    case MessageTypes::Compound:
...
{
  if ( msg.isFixedSize())
    return impl::call_for_array_message<true, true>( msg, std::forward<Callable>( f ), std::forward<Args>( args )... );
  if ( msg.isBounded())
    return impl::call_for_array_message<true, false>( msg, std::forward<Callable>( f ), std::forward<Args>( args )... );
  return impl::call_for_array_message<false, false>( msg, std::forward<Callable>( f ), std::forward<Args>( args )... );
}
...
#endif //ROS_BABEL_FISH_METHOD_INVOKE_HELPERS_HPP
