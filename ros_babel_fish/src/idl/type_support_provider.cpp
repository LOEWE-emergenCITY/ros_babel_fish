...
MessageTypeSupport::ConstSharedPtr TypeSupportProvider::getMessageTypeSupport( const std::string &type ) const
{
  // Check cache
...
ServiceTypeSupport::ConstSharedPtr TypeSupportProvider::getServiceTypeSupport( const std::string &type ) const
{
  // Check cache
...
ActionTypeSupport::ConstSharedPtr TypeSupportProvider::getActionTypeSupport( const std::string &type ) const
{
  // Check cache
...
TypeSupportProvider::registerMessage( const std::string &name,
                                      const std::shared_ptr<void> &type_support_library,
...
TypeSupportProvider::registerService( const std::string &name, const std::shared_ptr<void> &type_support_library,
...
TypeSupportProvider::registerAction( const std::string &name, ActionTypeSupport::ConstSharedPtr type_support ) const
{
