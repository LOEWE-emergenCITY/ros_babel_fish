...
#ifndef ROS_BABEL_FISH_LOGGING_MACROS_HPP
#define ROS_BABEL_FISH_LOGGING_MACROS_HPP

#define RBF2_LOGGER ::rclcpp::get_logger( "ros_babel_fish" )
...
#endif // ROS_BABEL_FISH_LOGGING_MACROS_HPP
