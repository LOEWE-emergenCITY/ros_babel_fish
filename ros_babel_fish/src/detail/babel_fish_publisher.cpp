...
BabelFishPublisher::BabelFishPublisher( rclcpp::node_interfaces::NodeBaseInterface *node_base,
  ...
  : PublisherBase( node_base, topic, type_support, options.to_rcl_publisher_options<CompoundMessage>( qos ))
    , options_( options )
{
...
void BabelFishPublisher::post_init_setup( rclcpp::node_interfaces::NodeBaseInterface *node_base,
