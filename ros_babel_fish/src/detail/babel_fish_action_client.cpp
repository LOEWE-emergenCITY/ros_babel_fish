...
Client<ros_babel_fish::impl::BabelFishAction>::Client( rclcpp::node_interfaces::NodeBaseInterface::SharedPtr node_base,
...
std::shared_future<rclcpp_action::ClientGoalHandle<ros_babel_fish::impl::BabelFishAction>::WrappedResult>
...
void Client<ros_babel_fish::impl::BabelFishAction>::make_result_aware( GoalHandle::SharedPtr goal_handle )
{
