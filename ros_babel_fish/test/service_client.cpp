...
TEST( ServiceClientTest, tests )
{
  ...
  CompoundMessage::SharedPtr req = fish.create_service_request_shared( "example_interfaces/srv/AddTwoInts" );
  (*req)["a"] = 512;
  (*req)["b"] = 314;
  BabelFishServiceClient::SharedPtr client = fish.create_service_client( *node, "/test_service_client/two_ints",
...
int main( int argc, char **argv )
{
  ...
  auto service_two_ints = node->create_service<example_interfaces::srv::AddTwoInts>( "/test_service_client/two_ints",
