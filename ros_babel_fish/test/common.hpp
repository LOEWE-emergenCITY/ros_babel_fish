...
template<>
void fillArray<ros_babel_fish_test_msgs::msg::TestSubArray>( std::vector<ros_babel_fish_test_msgs::msg::TestSubArray> &msg,
                                                         unsigned seed )
{
  std::default_random_engine generator( seed );
  std::uniform_int_distribution<unsigned> distribution( std::numeric_limits<unsigned>::min());
...
template<size_t L>
void fillArray( std::array<ros_babel_fish_test_msgs::msg::TestSubArray, L> &msg,
                unsigned seed )
{
  std::default_random_engine generator( seed );
  std::uniform_int_distribution<unsigned> distribution( std::numeric_limits<unsigned>::min());
