...
template <>
bool MessageContentEqualImpl(const ros_babel_fish::Message &a, const builtin_interfaces::msg::Time &b,
...
template <>
bool MessageContentEqualImpl(const ros_babel_fish::Message &a, const builtin_interfaces::msg::Duration &b,
                             const std::string &path, ::testing::AssertionResult &result)
{
  using namespace ros_babel_fish;
  if (a.type() != MessageTypes::Compound)
...
typename std::enable_if<
    ros_babel_fish::message_type_traits::message_type<T>::value != ros_babel_fish::MessageTypes::None, bool>::type
ArrayContentEqualImpl(const ros_babel_fish::ArrayMessage_<T, BOUNDED, FIXED_LENGTH> &arr, const Container &b,
                      const std::string &path, ::testing::AssertionResult &result);

template <typename T, bool BOUNDED, bool FIXED_LENGTH, typename Container>
typename std::enable_if<
    ros_babel_fish::message_type_traits::message_type<T>::value == ros_babel_fish::MessageTypes::None, bool>::type
ArrayContentEqualImpl(const ros_babel_fish::ArrayMessage_<T, BOUNDED, FIXED_LENGTH> &, const Container &,
...
bool MessageContentEqualImpl(const ros_babel_fish::Message &a, const std::array<T, L> &b, const std::string &path,
                             ::testing::AssertionResult &result)
{
  using namespace ros_babel_fish;
  if (a.type() != MessageTypes::Array)
...
template <typename T, size_t L>
bool MessageContentEqualImpl(const ros_babel_fish::Message &a, const rosidl_runtime_cpp::BoundedVector<T, L> &b,
                             const std::string &path, ::testing::AssertionResult &result)
{
  using namespace ros_babel_fish;
  if (a.type() != MessageTypes::Array)
...
template <>
bool MessageContentEqualImpl(const ros_babel_fish::Message &a, const geometry_msgs::msg::Quaternion &b,
                             const std::string &path, ::testing::AssertionResult &result)
{
...
template <>
bool MessageContentEqualImpl(const ros_babel_fish::Message &a, const geometry_msgs::msg::PoseStamped &b,
                             const std::string &path, ::testing::AssertionResult &result)
{
...
template <>
bool MessageContentEqualImpl(const ros_babel_fish::Message &a, const ros_babel_fish_test_msgs::msg::TestMessage &b,
                             const std::string &path, ::testing::AssertionResult &result)
{
  if (!MessageContentEqualImpl(a["header"], b.header, path + ".header", result))
    return false;
...
template <>
bool MessageContentEqualImpl(const ros_babel_fish::Message &a, const ros_babel_fish_test_msgs::msg::TestArray &b,
                             const std::string &path, ::testing::AssertionResult &result)
{
...
template <>
bool MessageContentEqualImpl(const ros_babel_fish::Message &a, const ros_babel_fish_test_msgs::msg::TestSubArray &b,
                             const std::string &path, ::testing::AssertionResult &result)
{
...
MessageContentEqual(const ros_babel_fish::Message::ConstSharedPtr &a, const MessageType &b)
{
  return MessageContentEqual(*a, b);
}
...
template <typename MessageType>
::testing::AssertionResult
MessageContentEqual(const std::shared_ptr<const MessageType> &b, const ros_babel_fish::Message &a)
{
  return MessageContentEqual(a, *b);
}
...
template <typename MessageType>
::testing::AssertionResult
MessageContentEqual(const MessageType &b, const ros_babel_fish::Message::ConstSharedPtr &a)
{
  return MessageContentEqual(*a, b);
}
