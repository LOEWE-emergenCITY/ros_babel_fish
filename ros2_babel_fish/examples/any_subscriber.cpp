...
public:
  ...
  void init()
  {
    ...
    subscription_ = fish->create_subscription(
        *this, topic_, 10,
        [this]( ros2_babel_fish::CompoundMessage::SharedPtr msg ) { topic_callback( msg ); } );
  }
...
void printArray( const ros2_babel_fish::CompoundArrayMessage_<BOUNDED, FIXED_LENGTH> &message,
