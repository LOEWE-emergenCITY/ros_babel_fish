...
private:
  ...
  ros2_babel_fish::BabelFish::SharedPtr fish_;
  rclcpp::TimerBase::SharedPtr timer_;
  ros2_babel_fish::BabelFishPublisher::SharedPtr pub_string_;
  ros2_babel_fish::BabelFishPublisher::SharedPtr pub_pose_;
  ros2_babel_fish::BabelFishPublisher::SharedPtr pub_posewcv_;
  size_t count_;
};
