...
int main( int argc, char **argv )
{
  ...
  BabelFish fish;
  auto client = fish.create_action_client( *node, "fibonacci", "action_tutorials_interfaces/action/Fibonacci" );
  ...
  std::shared_future<BabelFishActionClient::WrappedResult> result_future = client->async_get_result( goal_handle );
