...
{
std::shared_ptr<void> createContainer( const rosidl_typesupport_introspection_cpp::MessageMembers &members,
                                       rosidl_runtime_cpp::MessageInitialization initialization )
{
  auto result = std::shared_ptr<void>( new unsigned char[members.size_of_],
                                       [ members ]( void *data )
                                       {
