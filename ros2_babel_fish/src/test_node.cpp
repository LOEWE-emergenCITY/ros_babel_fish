...
{
public:
  TestNode() : Node( "ros2_babel_fish_test" )
  {
    INIT_PUB( geometry_msgs::msg::PoseStamped, pose_stamped );
    INIT_PUB( ros2_babel_fish_test_msgs::msg::TestMessage, test_message );
  }
  ...
  bool testMessage()
  {
    ...
    ros2_babel_fish::CompoundMessage::SharedPtr message = nullptr;
    auto message_sub = fish.create_subscription( *this, getTopic<MessageType>(), 10,
                                                 [ &message, &cond ]( ros2_babel_fish::CompoundMessage::SharedPtr msg )
                                                 {
                                                   message = msg;
                                                   cond->trigger();
                                                 } );
...
private:
  ...
  DECLARE_PUB( ros2_babel_fish_test_msgs::msg::TestMessage, test_message );
...
DEFINE_PUB( ros2_babel_fish_test_msgs::msg::TestMessage, test_message )
...
Test Node - Checks if ROS2 Babel Fish works with the middleware you are using.
  ...
  if ( !test<ros2_babel_fish_test_msgs::msg::TestMessage>( node, "ros2_babel_fish_test_msgs/msg/TestMessage" ))
