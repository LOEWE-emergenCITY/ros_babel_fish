...
template<typename T>
bool MessageContentEqualImpl( const ros2_babel_fish::Message &a, const T &b,
...
sameType( const ros2_babel_fish::Message &a, const std::string &path,
          ::testing::AssertionResult &result )
{
  using namespace ros2_babel_fish;
  constexpr MessageType mt = message_type_traits::message_type<T>::value;
...
template<>
bool MessageContentEqualImpl( const ros2_babel_fish::Message &a, const std::string &b,
                              const std::string &path, ::testing::AssertionResult &result )
{
  using namespace ros2_babel_fish;
...
template<>
bool MessageContentEqualImpl( const ros2_babel_fish::Message &a,
...
typename std::enable_if<ros2_babel_fish::message_type_traits::message_type<T>::value !=
                            ros2_babel_fish::MessageTypes::None,
                        bool>::type
ArrayContentEqualImpl( const ros2_babel_fish::ArrayMessage_<T, BOUNDED, FIXED_LENGTH> &arr,
...
typename std::enable_if<ros2_babel_fish::message_type_traits::message_type<T>::value ==
                            ros2_babel_fish::MessageTypes::None,
                        bool>::type
ArrayContentEqualImpl( const ros2_babel_fish::ArrayMessage_<T, BOUNDED, FIXED_LENGTH> &,
...
bool MessageContentEqualImpl( const ros2_babel_fish::Message &a, const std::vector<T, A> &b,
                              const std::string &path, ::testing::AssertionResult &result )
{
  using namespace ros2_babel_fish;
...
bool MessageContentEqualImpl( const ros2_babel_fish::Message &a, const std::array<T, L> &b,
                              const std::string &path, ::testing::AssertionResult &result )
{
  using namespace ros2_babel_fish;
  if ( a.type() != MessageTypes::Array ) {
...
template<>
bool MessageContentEqualImpl( const ros2_babel_fish::Message &a,
                              const ros2_babel_fish_test_msgs::msg::TestMessage &b,
                              const std::string &path, ::testing::AssertionResult &result )
{
  if ( !MessageContentEqualImpl( a["header"], b.header, path + ".header", result ) )
    return false;
...
template<>
bool MessageContentEqualImpl( const ros2_babel_fish::Message &a,
                              const ros2_babel_fish_test_msgs::msg::TestArray &b,
                              const std::string &path, ::testing::AssertionResult &result )
{
...
template<>
bool MessageContentEqualImpl( const ros2_babel_fish::Message &a,
                              const ros2_babel_fish_test_msgs::msg::TestSubArray &b,
                              const std::string &path, ::testing::AssertionResult &result )
{
...
template<typename MessageType>
::testing::AssertionResult MessageContentEqual( const ros2_babel_fish::Message::ConstSharedPtr &a,
                                                const MessageType &b )
{
  return MessageContentEqual( *a, b );
}
...
::testing::AssertionResult MessageContentEqual( const MessageType &b,
                                                const ros2_babel_fish::Message &a )
{
  return MessageContentEqual( a, b );
}
...
template<typename MessageType>
::testing::AssertionResult MessageContentEqual( const MessageType &b,
                                                const ros2_babel_fish::Message::ConstSharedPtr &a )
{
  return MessageContentEqual( *a, b );
}
