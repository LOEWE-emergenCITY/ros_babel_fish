...
#ifndef ROS2_BABEL_FISH_MESSAGE_COMPARISON_HPP
#define ROS2_BABEL_FISH_MESSAGE_COMPARISON_HPP
...
const char *MessageTypeName( ros2_babel_fish::MessageType type )
{
  switch ( type )
  {
    ...
    case ros2_babel_fish::MessageTypes::Bool:
      return "Bool";
    case ros2_babel_fish::MessageTypes::Octet:
      return "Octet";
    ...
    case ros2_babel_fish::MessageTypes::Int64:
      return "Int64";
    case ros2_babel_fish::MessageTypes::Float:
      return "Float";
    case ros2_babel_fish::MessageTypes::Double:
      return "Double";;
    case ros2_babel_fish::MessageTypes::LongDouble:
      return "LongDouble";
    case ros2_babel_fish::MessageTypes::String:
      return "String";
    case ros2_babel_fish::MessageTypes::WString:
      return "WString";
    case ros2_babel_fish::MessageTypes::Compound:
      return "Compound";
    case ros2_babel_fish::MessageTypes::Array:
      return "Array";
    case ros2_babel_fish::MessageTypes::Char:
      return "Char";
    case ros2_babel_fish::MessageTypes::WChar:
      return "WChar";
  }
  return "Invalid";
}
...
::testing::AssertionResult MessageContentEqual( const ros2_babel_fish::Message &a, const MessageType &b,
                                                const std::string &path = "msg" );

template<typename T>
bool MessageContentEqualImpl( const ros2_babel_fish::Message &a, const T &b, const std::string &path,
...
typename std::enable_if<!std::is_base_of<ros2_babel_fish::Message, T1>::value, bool>::type
...
template<typename T>
typename std::enable_if<is_basic_type<T>::value, bool>::type sameType( const ros2_babel_fish::Message &a,
...
template<>
bool MessageContentEqualImpl( const ros2_babel_fish::Message &a, const std::string &b, const std::string &path,
                              ::testing::AssertionResult &result )
{
  using namespace ros2_babel_fish;
...
template<>
bool MessageContentEqualImpl( const ros2_babel_fish::Message &a, const builtin_interfaces::msg::Time &b,
                              const std::string &path, ::testing::AssertionResult &result )
{
  ...
  if ( !MessageContentEqualImpl( a["sec"], b.sec, path + ".sec", result )) return false;
  return MessageContentEqualImpl( a["nanosec"], b.nanosec, path + ".nanosec", result );
}

template<>
bool MessageContentEqualImpl( const ros2_babel_fish::Message &a, const builtin_interfaces::msg::Duration &b,
                              const std::string &path, ::testing::AssertionResult &result )
{
  using namespace ros2_babel_fish;
  if ( a.type() != MessageTypes::Compound )
...
typename std::enable_if<
  ros2_babel_fish::message_type_traits::message_type<T>::value != ros2_babel_fish::MessageTypes::None, bool>::type
ArrayContentEqualImpl( const ros2_babel_fish::ArrayMessage_<T, BOUNDED, FIXED_LENGTH> &arr, const Container &b,
                       const std::string &path, ::testing::AssertionResult &result );

template<typename T, bool BOUNDED, bool FIXED_LENGTH, typename Container>
typename std::enable_if<
  ros2_babel_fish::message_type_traits::message_type<T>::value == ros2_babel_fish::MessageTypes::None, bool>::type
ArrayContentEqualImpl( const ros2_babel_fish::ArrayMessage_<T, BOUNDED, FIXED_LENGTH> &, const Container &,
...
bool ArrayContentEqualImpl( const ros2_babel_fish::CompoundArrayMessage_<BOUNDED, FIXED_LENGTH> &arr,
                            const Container &b, const std::string &path, ::testing::AssertionResult &result );

template<typename T, typename A>
bool MessageContentEqualImpl( const ros2_babel_fish::Message &a, const std::vector<T, A> &b, const std::string &path,
                              ::testing::AssertionResult &result )
{
  using namespace ros2_babel_fish;
...
bool MessageContentEqualImpl( const ros2_babel_fish::Message &a, const std::array<T, L> &b, const std::string &path,
                              ::testing::AssertionResult &result )
{
  using namespace ros2_babel_fish;
  if ( a.type() != MessageTypes::Array )
  ...
  if ( arr.size() != b.size())
  {
    result = ::testing::AssertionFailure() << "Fixed Array length at " << path << " doesn't match!" << std::endl
                                           << "BF  length: " << arr.size() << std::endl
                                           << "MSG length: " << b.size();
    return false;
  }
  if ( arr.elementType() == MessageTypes::Compound )
    return ArrayContentEqualImpl( arr.template as<FixedLengthCompoundArrayMessage>(), b, path, result );
  return ArrayContentEqualImpl( arr.template as<FixedLengthArrayMessage<T>>(), b, path, result );
}

template<typename T, size_t L>
bool MessageContentEqualImpl( const ros2_babel_fish::Message &a, const rosidl_runtime_cpp::BoundedVector<T, L> &b,
                              const std::string &path, ::testing::AssertionResult &result )
{
  using namespace ros2_babel_fish;
  if ( a.type() != MessageTypes::Array )
...
template<>
bool MessageContentEqualImpl( const ros2_babel_fish::Message &a, const std_msgs::msg::Header &b,
                              const std::string &path, ::testing::AssertionResult &result )
{
...
template<>
bool MessageContentEqualImpl( const ros2_babel_fish::Message &a, const geometry_msgs::msg::Point &b,
                              const std::string &path, ::testing::AssertionResult &result )
{
...
template<>
bool MessageContentEqualImpl( const ros2_babel_fish::Message &a, const geometry_msgs::msg::Quaternion &b,
                              const std::string &path, ::testing::AssertionResult &result )
{
...
template<>
bool MessageContentEqualImpl( const ros2_babel_fish::Message &a, const geometry_msgs::msg::Pose &b,
                              const std::string &path, ::testing::AssertionResult &result )
{
...
template<>
bool MessageContentEqualImpl( const ros2_babel_fish::Message &a, const geometry_msgs::msg::PoseStamped &b,
                              const std::string &path, ::testing::AssertionResult &result )
{
...
template<>
bool MessageContentEqualImpl( const ros2_babel_fish::Message &a, const ros2_babel_fish_test_msgs::msg::TestMessage &b,
                              const std::string &path, ::testing::AssertionResult &result )
{
  if ( !MessageContentEqualImpl( a["header"], b.header, path + ".header", result )) return false;
...
template<>
bool MessageContentEqualImpl( const ros2_babel_fish::Message &a, const ros2_babel_fish_test_msgs::msg::TestArray &b,
                              const std::string &path, ::testing::AssertionResult &result )
{
...
template<>
bool MessageContentEqualImpl( const ros2_babel_fish::Message &a, const ros2_babel_fish_test_msgs::msg::TestSubArray &b,
                              const std::string &path, ::testing::AssertionResult &result )
{
...
template<typename MessageType>
::testing::AssertionResult MessageContentEqual( const ros2_babel_fish::Message &a,
...
MessageContentEqual( const ros2_babel_fish::Message::ConstSharedPtr &a, const MessageType &b )
{
  return MessageContentEqual( *a, b );
}

template<typename MessageType>
::testing::AssertionResult MessageContentEqual( const MessageType &b, const ros2_babel_fish::Message &a )
{
  return MessageContentEqual( a, b );
}
...
template<typename MessageType>
::testing::AssertionResult
MessageContentEqual( const std::shared_ptr<const MessageType> &b, const ros2_babel_fish::Message &a )
{
  return MessageContentEqual( a, *b );
}
...
template<typename MessageType>
::testing::AssertionResult
MessageContentEqual( const MessageType &b, const ros2_babel_fish::Message::ConstSharedPtr &a )
{
  return MessageContentEqual( *a, b );
}
...
#endif // ROS2_BABEL_FISH_MESSAGE_COMPARISON_HPP
