...
protected:
  ...
  void SetUp() override
  {
    ...
    test_msg = fish->create_message_shared( "ros2_babel_fish_test_msgs/TestMessage" );
    {
    ...
    test_array_msg = fish->create_message_shared( "ros2_babel_fish_test_msgs/TestArray" );
    {
